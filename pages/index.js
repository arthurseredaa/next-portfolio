    ...
    <section className="fj-hero">
      <div className="fj-hero-wrapper row">
        <div className="hero-left col-md-6">
          <h1 className="white hero-title">Hey I'm Arthur. Experienced React developer</h1>
          {/* <h2 className="white hero-subtitle">Check my portfolio and video tutorials</h2> */}
          <div className="button-container">
            <Link href="/portfolio" passHref>
              <a href="" className="btn btn-main bg-blue ttu" style={{marginTop: "50px"}}>See my work</a>
            </Link>
          </div>
        </div>
